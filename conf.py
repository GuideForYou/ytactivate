...
project = 'Activate YouTube on Your Device'
copyright = '2025, YouTube'
author = 'YouTube Help Team'
...
# Basic page info
html_title = "How to Use yt.be/activate to Connect Your Device to YouTube"
html_short_title = "YouTube Activation Guide"
